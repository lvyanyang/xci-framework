...
def generateMapper(Writer out, DbTable t) {
    ...
    out.println "\t<!--    select count(1) from ${t.name}-->"
...
def generateIndex(Writer out, DbTable t) {
    def tFieldName = objectName(t.name, false)
    out.println "<#ftl output_format=\"undefined\">"
    ...
    out.println "    <@echo test=(allowUpdate||allowDelete)>"
    out.println "        <ul class=\"dropdown-menu\">"
    out.println "            <@echo test=allowUpdate><li><a id=\"btn-cmedit\"><i class=\"icon-pencil\"></i> 编辑</a></li></@xci.echo>"
    out.println "            <@echo test=allowDelete><li><a id=\"btn-cmdelete\"><i class=\"icon-trash\"></i> 删除</a></li></@xci.echo>"
    out.println "        </ul>"
    out.println "    </@xci.echo>"
    out.println "</div>"
...
def generateDetails(Writer out, DbTable t) {
    ...
    t.fields.each() {
        ...
        if (it.type == "Date") {
            ...
            out.println "                    \t<td>\${entity.${it.javaName}?html}</td>"
        }
        out.println "                    </tr>"
    }
    out.println "                </table>"
