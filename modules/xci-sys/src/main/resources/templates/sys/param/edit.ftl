<#-- @ftlvariable name="entity" type="com.github.lvyanyang.sys.entity.SysParam" -->
<#include "/_inc/_layout.ftl">
<#assign url=saveUrl("/sys/param/","createSave","updateSave")/>
<@header/>
            ...
            <tr>
                ...
                <td>
                    <select class="form-control jxselect" name="category"
                        ...
                        <option></option>
                        ${sys.dicSysParamCategory(entity.category)}
                    </select>
                </td>
            </tr>
            <tr>
