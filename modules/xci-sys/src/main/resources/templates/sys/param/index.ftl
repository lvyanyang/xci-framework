...
<#assign allowInsert=sys.auth("sys.param.insert")/>
<#assign allowUpdate=sys.auth("sys.param.update")/>
...
<div id="gridcmenu">
    <@echo test=(allowUpdate||allowDelete)>
        <ul class="dropdown-menu">
            <@echo test=allowUpdate>
                <li><a id="btn-cmedit"><i class="icon-pencil"></i> 编辑</a></li></@echo>
            <@echo test=allowDelete>
                <li><a id="btn-cmdelete"><i class="icon-trash"></i> 删除</a></li></@echo>
        </ul>
    </@echo>
</div>
